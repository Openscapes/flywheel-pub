...
The NASA Openscapes Framework scales the Openscapes Approach beyond the Champions program into a movement, by identifying and supporting Open science leaders within organizations - our goal is for Openscapes to leave NASA when the project concludes, with the mentor community sustaining itself, and this only happens if the importance of their work is visible and valued. The Framework has three components: (1) Engage bright spots to strengthen awareness and excitement; (2) Empower a learning culture to strengthen confidence and skills (3) Amplify Open science leaders to strengthen the Open movement. 
...
**Create space and place**. As we all had different backgrounds, different experiences and expertise, technical skills and technologies, with DAACs in different stages of the migration to the cloud, our early conversations tended towards what was unique and distinct. Part of welcoming bright spots is listening across different vocabularies to identify a shared agenda. It took time (and gentle but consistent facilitation) for those conversations to shift from distinct to what we had in common - we found shared goals and challenges as we identified our trailhead on the path of working together.
